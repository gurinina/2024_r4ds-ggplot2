...
g1 <- ggplot(mpg, aes(x = displ, y = hwy, color = class)) + geom_point() 

g2 <- ggplot(mpg, aes(x = displ, y = hwy, shape = class)) + geom_point() 
...
# Top
g1 <- (ggplot(mpg, aes(x = displ, y = hwy, shape = drv)) + 
  geom_smooth())

# Bottom
g2 <- ggplot(mpg, aes(x = displ, y = hwy, linetype = drv)) + 
  geom_smooth()
